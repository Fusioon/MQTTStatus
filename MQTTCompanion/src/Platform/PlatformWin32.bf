...
class PlatformWin32 : PlatformOS
{
	...
	static c_wchar[?] APP_REGISTRY_NAME_WIDE = Compiler.ProjectName.ToConstNativeW();
	...
	{
		if (current == ToastNotifier.TOAST_ACTIVATED_ARG)
		{
			return .Ok(true);
		}
	...
	{
		Try!(SetRunAtStart(true));
		return .Ok;
	}

	public override Result<void> Uninstall()
	{
		Try!(SetRunAtStart(false));
		return .Ok;
	}
	...
	public override int Run()
	{
		...
		MQTTCommon.Win32_IPCClient ipcClient = scope .();
